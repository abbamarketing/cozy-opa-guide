...
const TERMS_SECTIONS = [
  ...
  { title: '8. Propriedade Intelectual', items: ['O cliente mantém todos os direitos sobre o conteúdo original enviado.', 'O conteúdo entregue pelo editor é de propriedade do Cliente após aprovação.', 'O VideoFlow não reivindica propriedade sobre os vídeos editados ou brutos.', 'O Cliente garante que possui os direitos sobre todo material enviado (brutos, logos, músicas).', 'O VideoFlow não se responsabiliza por violações de direitos autorais no material fornecido pelo Cliente.'] },
  ...
  { title: '11. Suspensão e Rescisão', paragraphs: ['O VideoFlow reserva-se o direito de suspender ou encerrar contas em caso de:'], items: ['Inadimplência por mais de 7 dias.', 'Uso abusivo ou fora dos fins previstos.', 'Violação destes Termos.'] },
  { title: '12. Limitação de Responsabilidade', paragraphs: ['O VideoFlow não garante disponibilidade ininterrupta da Plataforma. Não nos responsabilizamos por danos indiretos, lucros cessantes ou perda de dados decorrentes do uso da Plataforma ou por falhas fora de nosso controle.'] },
