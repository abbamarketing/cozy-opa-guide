...
const TERMS_SECTIONS = [
  ...
  { title: '10. Cancelamento e Reembolso', paragraphs: ['O plano Standard possui garantia de satisfação de 7 (sete) dias corridos a partir da data de confirmação do pagamento. Caso o Cliente não fique satisfeito com o serviço durante esse período, poderá solicitar o cancelamento e o reembolso integral do valor pago, sem necessidade de justificativa. A solicitação deve ser feita pelo e-mail abbaestrategias@gmail.com dentro do prazo de 7 dias.'], items: ['O Cliente pode cancelar a assinatura a qualquer momento via portal de pagamento, com efeito na próxima fatura.', 'Após o cancelamento, o acesso permanece ativo até o fim do período já pago.', 'Entregas em andamento serão concluídas normalmente.', 'Para os demais planos (Pro, Business, Premium e Agency), não há reembolso proporcional para períodos não utilizados.', 'A garantia de 7 dias aplica-se exclusivamente ao plano Standard e apenas à primeira assinatura do Cliente.'] },
