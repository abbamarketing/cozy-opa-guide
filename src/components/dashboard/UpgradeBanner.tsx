      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0 space-y-1">
          ...
          <p className="text-sm font-semibold text-foreground">
            Ascenda ao <span className="font-bold">{nextPlan.label}</span>
          </p>
          ...
          <div className="flex flex-wrap items-center gap-2 pt-1">
            <span className="inline-flex items-center rounded-full bg-primary/10 border border-border px-2 py-0.5 text-[11px] font-medium text-foreground">
              SLA {nextPlan.slaHours}h · {nextPlan.label}
            </span>
            <Button
              size="sm"
              onClick={handleCta}
              className="h-6 rounded-full bg-primary hover:opacity-80 text-primary-foreground font-semibold text-[11px] px-3"
            >
