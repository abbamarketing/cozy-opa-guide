                    ...
                    {delivery.is_exception && (
                      <div className="rounded-lg border border-border bg-secondary/50 p-3 space-y-1">
                        <div className="flex items-center gap-1.5">
                          <Badge className="bg-secondary text-foreground text-[10px]">Exceção ao briefing</Badge>
                        </div>
                        {delivery.exception_notes && (
                          <p className="text-sm text-muted-foreground whitespace-pre-wrap">{delivery.exception_notes}</p>
                        )}
                      </div>
                    )}
