      ...
      <div className="grid gap-6 sm:grid-cols-2 max-w-3xl">
        ...
        >
          <CardContent className="flex flex-col items-center gap-4 p-8 text-center">
            ...
            <h2 className="text-lg font-semibold text-foreground">Criar Roteiro</h2>
            <p className="text-sm text-muted-foreground">
              Crie roteiros profissionais com IA em 5 passos
            </p>
            <Button size="sm" className="mt-2">Começar</Button>
          </CardContent>
        </Card>
        ...
        >
          ...
          <CardContent className="flex flex-col items-center gap-4 p-8 text-center">
            ...
            <h2 className="text-lg font-semibold text-foreground">Ensaio Fotográfico</h2>
            <p className="text-sm text-muted-foreground">Gere fotos profissionais com IA</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Dialog open={photoDialogOpen} onOpenChange={setPhotoDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Esta funcionalidade está sendo desenvolvida. Quer ser avisado quando lançar?
            </DialogDescription>
          </DialogHeader>
